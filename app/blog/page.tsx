  ...
  return (
    <div>
      ...
      <h3 className="text-lg text-[#666666] dark:text-white font-body font-semibold">OUR BLOGS</h3>
        <h1 className="md:text-5xl text-3xl dark:text-white font-semibold text-center font-body leading-snug md:w-1/2 w-3/4  text-[#333333]">
        Find our all blogs from here
        </h1>
        <p className="text-[#666666] text-center dark:text-white md:px-28 px-8   mt-4 md:w-[50%]">
