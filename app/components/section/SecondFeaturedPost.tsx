...
const SecondFeaturedPost = () => {
  ...
  return (
    <section className="relative w-full h-auto dark:bg-[#181A2A] flex flex-col items-center justify-center md:px-28 md:py-28 p-8">
      {/* Wrapper Container: Has border on mobile; no border on desktop */}
      <div className="relative w-full border flex flex-col space-y-5 border-gray-300 dark:border-gray-700 md:border-0 rounded-lg  p-4 py-8">
        {/* Large Image */}
