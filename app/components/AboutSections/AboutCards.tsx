  ...
  return (
    ...
    <div
      className={`p-8 rounded-lg transition-all font-body duration-300 space-y-4 ${
        isActive ? "bg-[#7C4EE4] text-white shadow-lg" : "bg-gray-100  dark:bg-[#181A2A] text-[#666666]"}`}
    >
      <h2 className={`text-7xl font-bold ${isActive ? "text-white" : "text-[#666666] dark:text-white"}`}>{number}</h2>
